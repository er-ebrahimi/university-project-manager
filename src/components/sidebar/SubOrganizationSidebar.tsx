...
const SubOrganizationSidebar: React.FC<SubOrganizationSidebarProps> = ({ data }) => {
  // Define state for managing field values and edit mode
  const [isEditing, setIsEditing] = useState(false);
  const [universityData, setUniversityData] = useState({
    universityName:  `دانشکده‌ی ${data}` || "نام دانشکده را وارد کنید", // Use data or a default value
    phoneNumber: "021-۷۷۴۹۱۰۲۵",
    postalCode: "۱۳۱۱۴-۱۶۸۴۶",
    Nickname:data||"یونی",
    address: `تهران، نارمک، دانشگاه علم و صنعت ایران ، دانشکده‌ی ${data} `,
